...
function gpa(object) {
  ...
  gradesToWeight.forEach((key) => {
   let individualGrade = object[key];
   //console.log(individualGrade.grade);
   //console.log(individualGrade.weight);
    gradeSum += individualGrade.grade * individualGrade.weight;
    weightSum += individualGrade.weight;
  });
