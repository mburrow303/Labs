...
const pineappleCake = new Cake('vanilla', 'pineapple', 'sliced pineapple');
const lemonCake = new Cake('lemon', 'lemon', 'vanilla drizzle');
const brownieCake = new Cake('chocolate', 'chocolate', 'walnuts');

chocolateCake.describe();
pineappleCake.describe();
lemonCake.describe();
brownieCake.describe();
// Should print:
